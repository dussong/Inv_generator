...
//Logfile name
logfile := "logNbody_6BL_output.txt";
...
G := PermutationGroup<15 | (2,6)(3,7)(4,8)(5,9), (1, 6, 10, 13, 15, 5)(2, 7, 11, 14, 4, 9)(3, 8, 12)>; //6B
Gb := PermutationGroup<15 | (2,6)(3,7)(4,8)(5,9), (1, 6, 10, 13, 15, 5)(2, 7, 11, 14, 4, 9)(3, 8, 12)>; //6B
...
//        &+[(Q.1*Q.1*Q.1*Q.1*Q.1)^g:g in Group(Rpre)],
//        &+[(Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)],
//        &+[(Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6*Q.6)^g:g in Group(Rpre)]
//        ];
R1 := FundamentalInvariants(R);

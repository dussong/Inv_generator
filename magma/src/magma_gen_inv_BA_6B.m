...
//Logfile name
logfile := "logNbody_6BA_output.txt";
...
G := PermutationGroup<15 | (1,2)(7,10)(8,11)(9,12), (1,2,3,4,5)(6,10,13,15,9)(7,11,14,8,12)>; //6B
Gb := PermutationGroup<15 | (1,2)(7,10)(8,11)(9,12), (1,2,3,4,5)(6,10,13,15,9)(7,11,14,8,12)>; //6B
